...
class Container_187322f453 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\JendaPresenter' => [1 => ['application.2']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.3']],
			'App\Presenters\PizzaPresenter' => [1 => ['application.4']],
			'App\Presenters\SuchanekPresenter' => [1 => ['application.5']],
		...
		'services' => [
			...
			'application.2' => 'App\Presenters\JendaPresenter',
			'application.3' => 'App\Presenters\ErrorPresenter',
			'application.4' => 'App\Presenters\PizzaPresenter',
			'application.5' => 'App\Presenters\SuchanekPresenter',
	...
	public function createServiceApplication__2(): App\Presenters\JendaPresenter
	{
		$service = new App\Presenters\JendaPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__4(): App\Presenters\PizzaPresenter
	{
		$service = new App\Presenters\PizzaPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__5(): App\Presenters\SuchanekPresenter
	{
		$service = new App\Presenters\SuchanekPresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
