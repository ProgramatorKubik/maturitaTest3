<?php
// source: C:\wamp64\www\projects2\NETTE\app\presenters/templates/Homepage/default.latte

use Latte\Runtime as LR;

class Templateb97988ac34 extends Latte\Runtime\Template
{
	public $blocks = [
...
<div id="content">
    ...
    <div class="boxes">
        <div>
            <h2>NOTHING #1</h2>
            <p>No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No No</p>
        </div>

        <div>
            <h2>NOTHING #2</h2>
            <p>Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes Yes <p>
        </div>

        <div>
            <h2>NOTHING #3</h2>
            <p>Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No Yes Yes No Yes No</p>
        </div>
    </div>

    <h2 class="younot">We hope you NOT enjoy this framework!</h2>
    <center>
        <label for="IDname"><b>Identifikační číslo</b></label><br>
        <input type="text" placeholder="Vložte ID" name="IDname" required><br>

        <label for="psw"><b>Vstupní heslo</b></label><br>
        <input type="password" placeholder="Vložte heslo" name="password" required><br>

        <button type="submit" src="vstup  ">VSTUP</button>
        <br><br>
        ...
        <style>
            ...
            .boxes p a { color: #D51616; background: #f7f7f7; padding: 1px 3px; border-radius: 3px; text-decoration: none; box-shadow: 0 2px 5px rgba(0, 0, 0, .10); }
